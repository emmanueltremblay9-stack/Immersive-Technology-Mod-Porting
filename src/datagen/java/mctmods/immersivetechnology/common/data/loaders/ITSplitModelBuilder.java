...
public class ITSplitModelBuilder<T extends ModelBuilder<T>> extends CustomLoaderBuilder<T> {
    ...
    @Override public JsonObject toJson(JsonObject json) {
        ...
        json.addProperty(ITSplitModelLoader.DYNAMIC, isDynamic);
        json.add(ITSplitModelLoader.INNER_MODEL, modelToSplit.toJson());
        ...
        json.add(ITSplitModelLoader.PARTS, partsJson);
        return json;
    }
}
