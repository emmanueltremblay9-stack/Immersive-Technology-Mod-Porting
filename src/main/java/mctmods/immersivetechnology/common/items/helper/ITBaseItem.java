...
public class ITBaseItem extends Item {
    ...
    public boolean canEquip(ItemStack stack, EquipmentSlot armorType, Entity entity) { return entity instanceof LivingEntity living && living.getEquipmentSlotForItem(stack) == armorType || getEquipmentSlot(stack) == armorType; }
