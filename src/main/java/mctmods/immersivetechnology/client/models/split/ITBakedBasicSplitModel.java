...
public class ITBakedBasicSplitModel extends ITAbstractSplitModel<BakedModel> {
    private static final Set<ITBakedBasicSplitModel> WEAK_INSTANCES = Collections.newSetFromMap(new WeakHashMap<>());
    ...
    public ITBakedBasicSplitModel(BakedModel base, Set<Vec3i> parts, ModelState transform, Vec3i size, ItemTransforms itemTransforms) {
        super(base, size);
