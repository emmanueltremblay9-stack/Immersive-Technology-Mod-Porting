...
public record ITUnbakedSplitModel(UnbakedModel baseModel, Set<Vec3i> parts, boolean dynamic, @Nonnull Vec3i size) implements IUnbakedGeometry<ITUnbakedSplitModel> {
    public ITUnbakedSplitModel(UnbakedModel baseModel, List<Vec3i> parts, boolean dynamic, @Nonnull Vec3i size) {
