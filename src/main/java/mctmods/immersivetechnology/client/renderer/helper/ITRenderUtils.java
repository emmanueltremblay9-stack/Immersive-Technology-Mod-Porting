...
public class ITRenderUtils {
    ...
    private static final int UV_OFFSET = FORMAT.getOffset(VertexFormatElement.UV0) / Integer.BYTES;
    private static final int POSITION_OFFSET = FORMAT.getOffset(VertexFormatElement.POSITION) / Integer.BYTES;
