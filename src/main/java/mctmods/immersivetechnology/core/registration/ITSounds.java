...
public class ITSounds {
    ...
    private static DeferredHolder<SoundEvent, SoundEvent> registerSound(String name) { return REGISTER.register(name, () -> SoundEvent.createVariableRangeEvent(ITLib.rl(name))); }
}
