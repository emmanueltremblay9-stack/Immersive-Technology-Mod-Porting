...
public class ITParticles {
    ...
    public static final DeferredHolder<ParticleType<?>, ParticleType<ColoredSmoke>> COLORED_SMOKE = REGISTER.register("colored_smoke", () -> new ParticleType<>(false) {
        ...
        @Override @NotNull public StreamCodec<? super RegistryFriendlyByteBuf, ColoredSmoke> streamCodec() { return ColoredSmoke.STREAM_CODEC; }
    });

    public static final DeferredHolder<ParticleType<?>, SimpleParticleType> SMOKE_CUSTOM = REGISTER.register("smoke_custom", () -> new SimpleParticleType(true));
}
